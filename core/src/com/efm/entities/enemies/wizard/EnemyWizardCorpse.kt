...
class EnemyWizardCorpse(
        position : RoomPosition = RoomPosition(),
        loot : PossibleItems? = null,
        seed : Int = Random.nextInt()
                       ) : EnemyCorpse(position, loot, seed)
{
    override fun getTile() : TiledMapTile = Tiles.wizardCorpse
    override fun getOutlineYellowTile(n : Int) : TiledMapTile = Tiles.wizardCorpseOutlineYellow
