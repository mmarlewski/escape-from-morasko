...
internal class ExitTiles(
        ...
        val exitBossUp : TiledMapTile?,
        val exitBossRight : TiledMapTile?,
        val exitBossDown : TiledMapTile?,
        val exitBossLeft : TiledMapTile?,
        ...
        val exitBossUpClosed : TiledMapTile?,
        val exitBossRightClosed : TiledMapTile?,
        val exitBossDownClosed : TiledMapTile?,
        val exitBossLeftClosed : TiledMapTile?
                        )