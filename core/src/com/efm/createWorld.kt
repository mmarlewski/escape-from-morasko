...
fun World.addTestBigRoomsLevel()
{
    ...
    for (y in 1 until tbrl1.heightInSpaces)
    {
        tbrl1.addEntityAt(StoneWall(Direction4.right), 0, y)
    }
    for (x in 1 until tbrl1.widthInSpaces)
    {
        tbrl1.addEntityAt(StoneWall(Direction4.down), x, 0)
    }
    // tbrl2
    ...
    for (y in 1 until tbrl2.heightInSpaces)
    {
        tbrl2.addEntityAt(StoneWall(Direction4.right), 0, y)
    }
    for (x in 1 until tbrl2.widthInSpaces)
    {
        tbrl2.addEntityAt(StoneWall(Direction4.down), x, 0)
    }
    // tbrl3
    ...
    for (y in 1 until tbrl3.heightInSpaces)
    {
        tbrl3.addEntityAt(StoneWall(Direction4.right), 0, y)
    }
    for (x in 1 until tbrl3.widthInSpaces)
    {
        tbrl3.addEntityAt(StoneWall(Direction4.down), x, 0)
    }
    // tbrl4
    ...
    for (y in 1 until tbrl4.heightInSpaces)
    {
        tbrl4.addEntityAt(StoneWall(Direction4.right), 0, y)
    }
    for (x in 1 until tbrl4.widthInSpaces)
    {
        tbrl4.addEntityAt(StoneWall(Direction4.down), x, 0)
    }
    // room list
